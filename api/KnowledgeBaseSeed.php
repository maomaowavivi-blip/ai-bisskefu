...
class KnowledgeBaseSeed {
    ...
    private static function brandEntries(): array {
        return [
            [
                'question' => '柚光民宿是什么？',
                'answer' => '柚光民宿是面向客人的南宁城市民宿品牌，运营分散式公寓房源，为商旅客和短住客提供入住咨询与订单服务。',
                'keywords' => '柚光,柚光民宿,品牌,是什么,介绍',
                'similar' => ['你们是什么民宿', '柚光民宿是什么', '你们是什么品牌'],
            ],
            [
                'question' => '南宁柚光民宿有哪些区域？',
    ...
    private static function checkinEntries(): array {
        return [
            [
                'question' => '几点可以入住？',
                'answer' => '柚光民宿统一标准入住时间为当日14:00；如需提前入住，请联系掌柜，视房态协调。',
                'keywords' => '入住时间,几点入住,入住几点,几点进,什么时候能住,14点',
                'similar' => ['最早几点入住', '可以提前进吗', '下午几点入住', '几点可以入住'],
            ],
            [
                'question' => '几点退房？',
                'answer' => '柚光民宿统一标准退房时间为当日12:00；如需延迟退房，请联系掌柜，视房态安排。',
    ...
    private static function rulesEntries(): array {
        return [
            [
                'question' => '可以带宠物吗？',
                'answer' => '南宁柚光民宿统一不接受宠物入住（导盲犬等特殊需求请提前联系掌柜确认）。',
                'keywords' => '宠物,猫,狗,带宠',
            ],
            [
                'question' => '可以吸烟吗？',
                'answer' => '南宁柚光民宿室内统一禁止吸烟（含电子烟）；请在室外允许区域吸烟，违规可能产生清洁费用。',
    ...
    private static function feesEntries(): array {
        ...
        return [
            [
                'question' => '取消订单怎么算？',
                'answer' => "取消与改期请在您下单的{$platforms}订单内按平台规则操作，柚光民宿线上客服不办理取消或退款。",
    ...
    private static function serviceEntries(): array {
        return [
            [
                ...
                'answer' => '柚光民宿不提供接送机、生日布置、行李寄存等特殊增值服务。',
